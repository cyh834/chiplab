...
AM_DEVREG(25, GPIO_READ,    RD, uint32_t value);
...
AM_DEVREG(31, UART_CONFIG2,  RD, uint32_t baud; bool odd);
AM_DEVREG(34, TIMER_CONFIG2, WD, uint32_t cfg, cnt, cmp, step);
AM_DEVREG(35, TIMER_CHECKIRQ,RD, bool set);
AM_DEVREG(36, TIMER_CLEARIRQ,WD, bool set);
