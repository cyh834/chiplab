...
#define MMAP_EXEC   0x00000004 // can execute
#define MMAP_USER   0x00000008 // user pages
#define MMAP_ACCESS 0x00000010 // has been accessed
#define MMAP_DIRTY  0x00000020 // has been written
