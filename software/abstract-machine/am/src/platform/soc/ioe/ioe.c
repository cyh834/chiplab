...
void __am_uart_read(AM_UART_RX_T *);
void __am_uart_write(AM_UART_TX_T *);
void __am_gpio_read(AM_GPIO_READ_T *);
void __am_gpio_write(AM_GPIO_WRITE_T *);
void __am_intc_config(AM_INTC_CONFIG_T *);
...
static void *lut[128] = {
 ...
 // [AM_UART_CONFIG ] = __am_uart_config,
  ...
  [AM_GPIO_WRITE  ] = __am_gpio_write,
  [AM_INTC_CONFIG ] = __am_intc_config,
  [AM_INTC_CLEAR  ] = __am_intc_clear,  
