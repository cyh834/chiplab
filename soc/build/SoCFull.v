...
module AXI4SDRAM(	// src/device/SDRAM.scala:53:9
  input         clock,	// src/device/SDRAM.scala:53:9
                reset,	// src/device/SDRAM.scala:53:9
  output        auto_in_awready,	// rocket-chip/src/main/scala/diplomacy/LazyModule.scala:374:18
  input         auto_in_awvalid,	// rocket-chip/src/main/scala/diplomacy/LazyModule.scala:374:18
  input  [3:0]  auto_in_awid,	// rocket-chip/src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [1:0]  auto_in_rresp,	// rocket-chip/src/main/scala/diplomacy/LazyModule.scala:374:18
  output        auto_in_rlast,	// rocket-chip/src/main/scala/diplomacy/LazyModule.scala:374:18
                sdram_bundle_clk,	// src/device/SDRAM.scala:56:26
                sdram_bundle_cke,	// src/device/SDRAM.scala:56:26
                sdram_bundle_cs,	// src/device/SDRAM.scala:56:26
                sdram_bundle_ras,	// src/device/SDRAM.scala:56:26
                sdram_bundle_cas,	// src/device/SDRAM.scala:56:26
                sdram_bundle_we,	// src/device/SDRAM.scala:56:26
  output [13:0] sdram_bundle_a,	// src/device/SDRAM.scala:56:26
  output [1:0]  sdram_bundle_ba,	// src/device/SDRAM.scala:56:26
  output [3:0]  sdram_bundle_dqm,	// src/device/SDRAM.scala:56:26
  inout  [31:0] sdram_bundle_dq	// src/device/SDRAM.scala:56:26
);

  sdram_top_axi msdram (	// src/device/SDRAM.scala:57:24
    .clock            (clock),
    .reset            (reset),
    .in_awready      (auto_in_awready),
    .in_awvalid      (auto_in_awvalid),
    .in_awid    (auto_in_awid),
    .in_awaddr  ({2'h0, auto_in_awaddr}),	// src/device/SDRAM.scala:61:18
    ...
    .in_araddr  ({2'h0, auto_in_araddr}),	// src/device/SDRAM.scala:61:18
...
module SoCASIC(	// src/SoC.scala:55:9
  input         clock,	// src/SoC.scala:55:9
                reset,	// src/SoC.scala:55:9
  input  [7:0]  intr_from_SoC,	// src/SoC.scala:59:27
  input         intc_timer_int,	// src/SoC.scala:63:18
  output        intc_int_o,	// src/SoC.scala:63:18
                timer_int,	// src/SoC.scala:64:19
                spi_sck,	// src/SoC.scala:65:17
  output [7:0]  spi_ss,	// src/SoC.scala:65:17
  output        spi_mosi,	// src/SoC.scala:65:17
  input         spi_miso,	// src/SoC.scala:65:17
                uart_rx,	// src/SoC.scala:66:18
  output        uart_tx,	// src/SoC.scala:66:18
                sdram_clk,	// src/SoC.scala:67:19
                sdram_cke,	// src/SoC.scala:67:19
                sdram_cs,	// src/SoC.scala:67:19
                sdram_ras,	// src/SoC.scala:67:19
                sdram_cas,	// src/SoC.scala:67:19
                sdram_we,	// src/SoC.scala:67:19
  output [13:0] sdram_a,	// src/SoC.scala:67:19
  output [1:0]  sdram_ba,	// src/SoC.scala:67:19
  output [3:0]  sdram_dqm,	// src/SoC.scala:67:19
  inout  [31:0] sdram_dq,	// src/SoC.scala:67:19
  output [5:0]  gpio_out,	// src/SoC.scala:68:18
  input  [3:0]  gpio_in,	// src/SoC.scala:68:18
  output        sram_reset,	// src/SoC.scala:70:18
                sram_oce,	// src/SoC.scala:70:18
                sram_clka,	// src/SoC.scala:70:18
                sram_cea,	// src/SoC.scala:70:18
  output [15:0] sram_ada,	// src/SoC.scala:70:18
  output [31:0] sram_din,	// src/SoC.scala:70:18
  output [3:0]  sram_byte_ena,	// src/SoC.scala:70:18
  output        sram_clkb,	// src/SoC.scala:70:18
                sram_ceb,	// src/SoC.scala:70:18
  output [15:0] sram_adb,	// src/SoC.scala:70:18
  input  [31:0] sram_dout	// src/SoC.scala:70:18
);
  ...
  wire        _lsdram_auto_in_awready;	// src/SoC.scala:36:27
  wire        _lsdram_auto_in_wready;	// src/SoC.scala:36:27
  wire        _lsdram_auto_in_bvalid;	// src/SoC.scala:36:27
  wire [3:0]  _lsdram_auto_in_bid;	// src/SoC.scala:36:27
  wire [1:0]  _lsdram_auto_in_bresp;	// src/SoC.scala:36:27
  wire        _lsdram_auto_in_arready;	// src/SoC.scala:36:27
  wire        _lsdram_auto_in_rvalid;	// src/SoC.scala:36:27
  wire [3:0]  _lsdram_auto_in_rid;	// src/SoC.scala:36:27
  wire [31:0] _lsdram_auto_in_rdata;	// src/SoC.scala:36:27
  wire [1:0]  _lsdram_auto_in_rresp;	// src/SoC.scala:36:27
  wire        _lsdram_auto_in_rlast;	// src/SoC.scala:36:27
  wire        _lsram_auto_in_awready;	// src/SoC.scala:35:27
  wire        _lsram_auto_in_wready;	// src/SoC.scala:35:27
  wire        _lsram_auto_in_bvalid;	// src/SoC.scala:35:27
  wire [3:0]  _lsram_auto_in_bid;	// src/SoC.scala:35:27
  wire [1:0]  _lsram_auto_in_bresp;	// src/SoC.scala:35:27
  wire        _lsram_auto_in_arready;	// src/SoC.scala:35:27
  wire        _lsram_auto_in_rvalid;	// src/SoC.scala:35:27
  wire [3:0]  _lsram_auto_in_rid;	// src/SoC.scala:35:27
  wire [31:0] _lsram_auto_in_rdata;	// src/SoC.scala:35:27
  wire [1:0]  _lsram_auto_in_rresp;	// src/SoC.scala:35:27
  wire        _lsram_auto_in_rlast;	// src/SoC.scala:35:27
  wire        _cpu_auto_master_out_awvalid;	// src/SoC.scala:33:23
  wire [3:0]  _cpu_auto_master_out_awid;	// src/SoC.scala:33:23
  wire [31:0] _cpu_auto_master_out_awaddr;	// src/SoC.scala:33:23
  wire [7:0]  _cpu_auto_master_out_awlen;	// src/SoC.scala:33:23
  wire [2:0]  _cpu_auto_master_out_awsize;	// src/SoC.scala:33:23
  wire [1:0]  _cpu_auto_master_out_awburst;	// src/SoC.scala:33:23
  wire        _cpu_auto_master_out_wvalid;	// src/SoC.scala:33:23
  wire [31:0] _cpu_auto_master_out_wdata;	// src/SoC.scala:33:23
  wire [3:0]  _cpu_auto_master_out_wstrb;	// src/SoC.scala:33:23
  wire        _cpu_auto_master_out_wlast;	// src/SoC.scala:33:23
  wire        _cpu_auto_master_out_bready;	// src/SoC.scala:33:23
  wire        _cpu_auto_master_out_arvalid;	// src/SoC.scala:33:23
  wire [3:0]  _cpu_auto_master_out_arid;	// src/SoC.scala:33:23
  wire [31:0] _cpu_auto_master_out_araddr;	// src/SoC.scala:33:23
  wire [7:0]  _cpu_auto_master_out_arlen;	// src/SoC.scala:33:23
  wire [2:0]  _cpu_auto_master_out_arsize;	// src/SoC.scala:33:23
  wire [1:0]  _cpu_auto_master_out_arburst;	// src/SoC.scala:33:23
  wire        _cpu_auto_master_out_rready;	// src/SoC.scala:33:23
  wire        _apbxbar_auto_in_pready;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_in_pslverr;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_in_prdata;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_4_psel;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_4_penable;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_4_pwrite;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_4_paddr;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_4_pwdata;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_3_psel;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_3_penable;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_3_pwrite;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_3_paddr;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_3_pwdata;	// src/SoC.scala:31:27
  wire [3:0]  _apbxbar_auto_out_3_pstrb;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_2_psel;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_2_penable;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_2_pwrite;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_2_paddr;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_2_pwdata;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_1_psel;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_1_penable;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_1_pwrite;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_1_paddr;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_1_pwdata;	// src/SoC.scala:31:27
  wire [3:0]  _apbxbar_auto_out_1_pstrb;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_0_psel;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_0_penable;	// src/SoC.scala:31:27
  wire        _apbxbar_auto_out_0_pwrite;	// src/SoC.scala:31:27
  wire [28:0] _apbxbar_auto_out_0_paddr;	// src/SoC.scala:31:27
  wire [31:0] _apbxbar_auto_out_0_pwdata;	// src/SoC.scala:31:27
  wire [3:0]  _apbxbar_auto_out_0_pstrb;	// src/SoC.scala:31:27
  ...
  AXI4Xbar axi4xbar (	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:230:30
    ...
    .auto_in_awvalid         (_cpu_auto_master_out_awvalid),	// src/SoC.scala:33:23
    .auto_in_awid       (_cpu_auto_master_out_awid),	// src/SoC.scala:33:23
    .auto_in_awaddr     (_cpu_auto_master_out_awaddr),	// src/SoC.scala:33:23
    .auto_in_awlen      (_cpu_auto_master_out_awlen),	// src/SoC.scala:33:23
    .auto_in_awsize     (_cpu_auto_master_out_awsize),	// src/SoC.scala:33:23
    .auto_in_awburst    (_cpu_auto_master_out_awburst),	// src/SoC.scala:33:23
    .auto_in_wready          (_axi4xbar_auto_in_wready),
    .auto_in_wvalid          (_cpu_auto_master_out_wvalid),	// src/SoC.scala:33:23
    .auto_in_wdata      (_cpu_auto_master_out_wdata),	// src/SoC.scala:33:23
    .auto_in_wstrb      (_cpu_auto_master_out_wstrb),	// src/SoC.scala:33:23
    .auto_in_wlast      (_cpu_auto_master_out_wlast),	// src/SoC.scala:33:23
    .auto_in_bready          (_cpu_auto_master_out_bready),	// src/SoC.scala:33:23
    ...
    .auto_in_arvalid         (_cpu_auto_master_out_arvalid),	// src/SoC.scala:33:23
    .auto_in_arid       (_cpu_auto_master_out_arid),	// src/SoC.scala:33:23
    .auto_in_araddr     (_cpu_auto_master_out_araddr),	// src/SoC.scala:33:23
    .auto_in_arlen      (_cpu_auto_master_out_arlen),	// src/SoC.scala:33:23
    .auto_in_arsize     (_cpu_auto_master_out_arsize),	// src/SoC.scala:33:23
    .auto_in_arburst    (_cpu_auto_master_out_arburst),	// src/SoC.scala:33:23
    .auto_in_rready          (_cpu_auto_master_out_rready),	// src/SoC.scala:33:23
    ...
    .auto_out_1_awready      (_lsdram_auto_in_awready),	// src/SoC.scala:36:27
    ...
    .auto_out_1_wready       (_lsdram_auto_in_wready),	// src/SoC.scala:36:27
    ...
    .auto_out_1_bvalid       (_lsdram_auto_in_bvalid),	// src/SoC.scala:36:27
    .auto_out_1_bid     (_lsdram_auto_in_bid),	// src/SoC.scala:36:27
    .auto_out_1_bresp   (_lsdram_auto_in_bresp),	// src/SoC.scala:36:27
    .auto_out_1_arready      (_lsdram_auto_in_arready),	// src/SoC.scala:36:27
    ...
    .auto_out_1_rvalid       (_lsdram_auto_in_rvalid),	// src/SoC.scala:36:27
    .auto_out_1_rid     (_lsdram_auto_in_rid),	// src/SoC.scala:36:27
    .auto_out_1_rdata   (_lsdram_auto_in_rdata),	// src/SoC.scala:36:27
    .auto_out_1_rresp   (_lsdram_auto_in_rresp),	// src/SoC.scala:36:27
    .auto_out_1_rlast   (_lsdram_auto_in_rlast),	// src/SoC.scala:36:27
  ...
  AXI4Xbar_1 axi4xbar_1 (	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:230:30
    ...
    .auto_out_1_awready      (_lsram_auto_in_awready),	// src/SoC.scala:35:27
    ...
    .auto_out_1_wready       (_lsram_auto_in_wready),	// src/SoC.scala:35:27
    ...
    .auto_out_1_bvalid       (_lsram_auto_in_bvalid),	// src/SoC.scala:35:27
    .auto_out_1_bid     (_lsram_auto_in_bid),	// src/SoC.scala:35:27
    .auto_out_1_bresp   (_lsram_auto_in_bresp),	// src/SoC.scala:35:27
    .auto_out_1_arready      (_lsram_auto_in_arready),	// src/SoC.scala:35:27
    ...
    .auto_out_1_rvalid       (_lsram_auto_in_rvalid),	// src/SoC.scala:35:27
    .auto_out_1_rid     (_lsram_auto_in_rid),	// src/SoC.scala:35:27
    .auto_out_1_rdata   (_lsram_auto_in_rdata),	// src/SoC.scala:35:27
    .auto_out_1_rresp   (_lsram_auto_in_rresp),	// src/SoC.scala:35:27
    .auto_out_1_rlast   (_lsram_auto_in_rlast),	// src/SoC.scala:35:27
  ...
  CPU cpu (	// src/SoC.scala:33:23
    .clock                         (clock),
    .reset                         (_cpu_reset_chain_io_q | reset),	// rocket-chip/src/main/scala/util/ShiftReg.scala:45:23, src/SoC.scala:57:64
  ...
  AXI4SRAM lsram (	// src/SoC.scala:35:27
    .clock                 (clock),
    .reset                 (reset),
  ...
  AXI4SDRAM lsdram (	// src/SoC.scala:36:27
    .clock                 (clock),
    .reset                 (reset),
  ...
  APBGPIO lgpio (	// src/SoC.scala:37:27
    .clock           (clock),
    .reset           (reset),
    .auto_in_psel    (_apbxbar_auto_out_3_psel),	// src/SoC.scala:31:27
    .auto_in_penable (_apbxbar_auto_out_3_penable),	// src/SoC.scala:31:27
    .auto_in_pwrite  (_apbxbar_auto_out_3_pwrite),	// src/SoC.scala:31:27
    .auto_in_paddr   (_apbxbar_auto_out_3_paddr),	// src/SoC.scala:31:27
    .auto_in_pwdata  (_apbxbar_auto_out_3_pwdata),	// src/SoC.scala:31:27
    .auto_in_pstrb   (_apbxbar_auto_out_3_pstrb),	// src/SoC.scala:31:27
  ...
  APBTimer ltimer (	// src/SoC.scala:38:27
    .clock            (clock),
    .reset            (reset),
    .auto_in_psel     (_apbxbar_auto_out_2_psel),	// src/SoC.scala:31:27
    .auto_in_penable  (_apbxbar_auto_out_2_penable),	// src/SoC.scala:31:27
    .auto_in_pwrite   (_apbxbar_auto_out_2_pwrite),	// src/SoC.scala:31:27
    .auto_in_paddr    (_apbxbar_auto_out_2_paddr),	// src/SoC.scala:31:27
    .auto_in_pwdata   (_apbxbar_auto_out_2_pwdata),	// src/SoC.scala:31:27
  ...
  APBINTC lintc (	// src/SoC.scala:39:27
    .clock                 (clock),
    .reset                 (reset),
    .auto_in_psel          (_apbxbar_auto_out_4_psel),	// src/SoC.scala:31:27
    .auto_in_penable       (_apbxbar_auto_out_4_penable),	// src/SoC.scala:31:27
    .auto_in_pwrite        (_apbxbar_auto_out_4_pwrite),	// src/SoC.scala:31:27
    .auto_in_paddr         (_apbxbar_auto_out_4_paddr),	// src/SoC.scala:31:27
    .auto_in_pwdata        (_apbxbar_auto_out_4_pwdata),	// src/SoC.scala:31:27
  ...
  APBUart luart (	// src/SoC.scala:40:27
    .clock           (clock),
    .reset           (reset),
    .auto_in_psel    (_apbxbar_auto_out_1_psel),	// src/SoC.scala:31:27
    .auto_in_penable (_apbxbar_auto_out_1_penable),	// src/SoC.scala:31:27
    .auto_in_pwrite  (_apbxbar_auto_out_1_pwrite),	// src/SoC.scala:31:27
    .auto_in_paddr   (_apbxbar_auto_out_1_paddr),	// src/SoC.scala:31:27
    .auto_in_pwdata  (_apbxbar_auto_out_1_pwdata),	// src/SoC.scala:31:27
    .auto_in_pstrb   (_apbxbar_auto_out_1_pstrb),	// src/SoC.scala:31:27
  ...
  APBSPI lspi (	// src/SoC.scala:43:25
    .clock           (clock),
    .reset           (reset),
    .auto_in_psel    (_apbxbar_auto_out_0_psel),	// src/SoC.scala:31:27
    .auto_in_penable (_apbxbar_auto_out_0_penable),	// src/SoC.scala:31:27
    .auto_in_pwrite  (_apbxbar_auto_out_0_pwrite),	// src/SoC.scala:31:27
    .auto_in_paddr   (_apbxbar_auto_out_0_paddr),	// src/SoC.scala:31:27
    .auto_in_pwdata  (_apbxbar_auto_out_0_pwdata),	// src/SoC.scala:31:27
    .auto_in_pstrb   (_apbxbar_auto_out_0_pstrb),	// src/SoC.scala:31:27
  ...
  AXI4ToAPB axi42apb (	// src/amba/AXI4ToAPB.scala:103:30
    ...
    .auto_out_pready      (_apbxbar_auto_in_pready),	// src/SoC.scala:31:27
    .auto_out_pslverr     (_apbxbar_auto_in_pslverr),	// src/SoC.scala:31:27
    .auto_out_prdata      (_apbxbar_auto_in_prdata)	// src/SoC.scala:31:27
...
module SoCFull(	// src/SoC.scala:91:9
  ...
  output        spi_sck,	// src/SoC.scala:98:17
  output [7:0]  spi_ss,	// src/SoC.scala:98:17
  output        spi_mosi,	// src/SoC.scala:98:17
  input         spi_miso,	// src/SoC.scala:98:17
  output        sdram_clk,	// src/SoC.scala:101:19
                sdram_cke,	// src/SoC.scala:101:19
                sdram_cs,	// src/SoC.scala:101:19
                sdram_ras,	// src/SoC.scala:101:19
                sdram_cas,	// src/SoC.scala:101:19
                sdram_we,	// src/SoC.scala:101:19
  output [13:0] sdram_a,	// src/SoC.scala:101:19
  output [1:0]  sdram_ba,	// src/SoC.scala:101:19
  output [3:0]  sdram_dqm,	// src/SoC.scala:101:19
  inout  [31:0] sdram_dq,	// src/SoC.scala:101:19
  output [5:0]  externalPins_gpio_out,	// src/SoC.scala:104:26
  input  [3:0]  externalPins_gpio_in,	// src/SoC.scala:104:26
  input         externalPins_uart_rx,	// src/SoC.scala:104:26
  output        externalPins_uart_tx	// src/SoC.scala:104:26
);

  wire [31:0] _sram_dout;	// src/SoC.scala:95:22
  wire        _pll_pll_clkout0;	// src/device/PLL.scala:28:21
  ...
  always @(posedge clock) begin	// src/SoC.scala:91:9
    if (~(externalPins_gpio_in[0]))	// src/SoC.scala:91:9, :122:{25,46}
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/SoC.scala:91:9
    ...
    initial begin	// src/SoC.scala:91:9
      automatic logic [31:0] _RANDOM[0:1];	// src/SoC.scala:91:9
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/SoC.scala:91:9
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          _RANDOM[i[0]] = `RANDOM;	// src/SoC.scala:91:9
        end	// src/SoC.scala:91:9
        cnt_value = _RANDOM[1'h1][15:0];	// src/SoC.scala:91:9, src/main/scala/chisel3/util/Counter.scala:61:40
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  SoCASIC asic (	// src/SoC.scala:85:24
    .clock          (_pll_pll_clkout0),	// src/device/PLL.scala:28:21
    .reset          (_rst_T & cnt_value > 16'hA),	// src/SoC.scala:123:20, :126:{48,62}, src/main/scala/chisel3/util/Counter.scala:61:40
    .intr_from_SoC  ({7'h0, _asic_intc_int_o}),	// src/SoC.scala:85:24, :131:25
    ...
    .sram_dout      (_sram_dout)	// src/SoC.scala:95:22
  );	// src/SoC.scala:85:24
  Gowin_PLL pll_pll (	// src/device/PLL.scala:28:21
    .clkin   (clock),
    .clkout0 (_pll_pll_clkout0),
    .clkout1 (/* unused */)
  );	// src/device/PLL.scala:28:21
  SRAM_SDPB sram (	// src/SoC.scala:95:22
...
module SoCTop(	// src/Top.scala:15:7
  ...
  wire        _dut_sdram_clk;	// src/Top.scala:19:20
  wire        _dut_sdram_cke;	// src/Top.scala:19:20
  wire        _dut_sdram_cs;	// src/Top.scala:19:20
  wire        _dut_sdram_ras;	// src/Top.scala:19:20
  wire        _dut_sdram_cas;	// src/Top.scala:19:20
  wire        _dut_sdram_we;	// src/Top.scala:19:20
  wire [13:0] _dut_sdram_a;	// src/Top.scala:19:20
  wire [1:0]  _dut_sdram_ba;	// src/Top.scala:19:20
  wire [3:0]  _dut_sdram_dqm;	// src/Top.scala:19:20
  wire [31:0] _dq_wire;	// src/Top.scala:29:21
  SoCFull dut (	// src/Top.scala:19:20
    ...
    .sdram_clk             (_dut_sdram_clk),
    .sdram_cke             (_dut_sdram_cke),
    .sdram_cs              (_dut_sdram_cs),
    .sdram_ras             (_dut_sdram_ras),
    .sdram_cas             (_dut_sdram_cas),
    .sdram_we              (_dut_sdram_we),
    .sdram_a               (_dut_sdram_a),
    .sdram_ba              (_dut_sdram_ba),
    .sdram_dqm             (_dut_sdram_dqm),
    .sdram_dq              (_dq_wire),
  ...
  sdram sdram (	// src/Top.scala:29:21
    .clk (_dut_sdram_clk),	// src/Top.scala:19:20
    .cke (_dut_sdram_cke),	// src/Top.scala:19:20
    .cs  (_dut_sdram_cs),	// src/Top.scala:19:20
    .ras (_dut_sdram_ras),	// src/Top.scala:19:20
    .cas (_dut_sdram_cas),	// src/Top.scala:19:20
    .we  (_dut_sdram_we),	// src/Top.scala:19:20
    .a   (_dut_sdram_a),	// src/Top.scala:19:20
    .ba  (_dut_sdram_ba),	// src/Top.scala:19:20
    .dqm (_dut_sdram_dqm),	// src/Top.scala:19:20
    .dq  (_dq_wire)
  );	// src/Top.scala:29:21
endmodule
